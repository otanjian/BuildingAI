...
import { formatProjectHealthDateTime } from "../../lib/format-datetime";
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatProjectHealthDateTime(a.checkTime)}</td>
                                <td>{formatProjectHealthDateTime(a.createTime)}</td>
                                <td>{formatProjectHealthDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
