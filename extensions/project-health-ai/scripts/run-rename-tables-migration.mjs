/**
 * Run PRJ 0.1.3 table rename migration (project-health-* prefix).
 *
 * Usage (from repo root, after `pnpm --filter project-health-ai build:api`):
 *   node extensions/project-health-ai/scripts/run-rename-tables-migration.mjs
 */
...
try {
    ...
    const tables = await dataSource.query(
        `SELECT table_name FROM information_schema.tables
         WHERE table_schema = 'project_health_ai'
         ORDER BY table_name`,
    );
