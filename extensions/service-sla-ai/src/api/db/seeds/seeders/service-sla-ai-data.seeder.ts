...
export class ServiceSlaAiDataSeeder extends BaseSeeder {
    readonly name = "ServiceSlaAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                ...
                ruleId: "SLA_001",
                description: "售后服务 SLA 自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "SLA-20260525-002",
                ruleId: "SLA_008",
                description: "售后服务 SLA 自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
