...
import { formatServiceSlaDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="service-sla-card">
                <table className="service-sla-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatServiceSlaDateTime(a.checkTime)}</td>
                                <td>{formatServiceSlaDateTime(a.createTime)}</td>
                                <td>{formatServiceSlaDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
