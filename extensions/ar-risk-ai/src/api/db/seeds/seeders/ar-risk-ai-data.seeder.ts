...
export class ArRiskAiDataSeeder extends BaseSeeder {
    readonly name = "ArRiskAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "AR-20260525-001",
                ruleId: "AR_001",
                description: "应收账款风控自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "AR-20260525-002",
                ruleId: "AR_008",
                description: "应收账款风控自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
