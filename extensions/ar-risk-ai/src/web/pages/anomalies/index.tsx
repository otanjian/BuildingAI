...
import { formatArRiskDateTime } from "../../lib/format-datetime";
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatArRiskDateTime(a.checkTime)}</td>
                                <td>{formatArRiskDateTime(a.createTime)}</td>
                                <td>{formatArRiskDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
