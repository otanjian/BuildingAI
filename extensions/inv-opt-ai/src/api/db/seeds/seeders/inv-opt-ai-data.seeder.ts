...
export class InvOptAiDataSeeder extends BaseSeeder {
    readonly name = "InvOptAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "INV-20260525-001",
                ruleId: "INV_001",
                description: "库存优化自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "INV-20260525-002",
                ruleId: "INV_008",
                description: "库存优化自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
