...
import { formatInvOptDateTime } from "../../lib/format-datetime";
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatInvOptDateTime(a.checkTime)}</td>
                                <td>{formatInvOptDateTime(a.createTime)}</td>
                                <td>{formatInvOptDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
