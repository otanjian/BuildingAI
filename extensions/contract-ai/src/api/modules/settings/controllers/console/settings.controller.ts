...
import { ContractPlatformAgentService } from "../../services/contract-platform-agent.service";
import { SettingsService } from "../../services/settings.service";

@ExtensionConsoleController("settings", "CTR Settings")
export class SettingsConsoleController extends BaseController {
    constructor(
        private readonly settingsService: SettingsService,
        private readonly ehcsPlatformAgentService: ContractPlatformAgentService,
    ) {
        super();
    }
