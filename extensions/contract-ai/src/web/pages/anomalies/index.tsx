...
import { formatContractDateTime } from "../../lib/format-datetime";
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatContractDateTime(a.checkTime)}</td>
                                <td>{formatContractDateTime(a.createTime)}</td>
                                <td>{formatContractDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
