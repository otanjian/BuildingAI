...
export class EsgReportAiDataSeeder extends BaseSeeder {
    readonly name = "EsgReportAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "ESG-20260525-001",
                ruleId: "ESG_001",
                description: "ESG 合规披露自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "ESG-20260525-002",
                ruleId: "ESG_008",
                description: "ESG 合规披露自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
