...
import { formatEsgReportDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="esg-report-card">
                <table className="esg-report-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatEsgReportDateTime(a.checkTime)}</td>
                                <td>{formatEsgReportDateTime(a.createTime)}</td>
                                <td>{formatEsgReportDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
