...
import { formatOtifDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="otif-card">
                <table className="otif-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatOtifDateTime(a.checkTime)}</td>
                                <td>{formatOtifDateTime(a.createTime)}</td>
                                <td>{formatOtifDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
