...
export class OtifAiDataSeeder extends BaseSeeder {
    readonly name = "OtifAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "OTIF-20260525-001",
                ruleId: "OTIF_001",
                description: "供应链 OTIF 自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "OTIF-20260525-002",
                ruleId: "OTIF_008",
                description: "供应链 OTIF 自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
