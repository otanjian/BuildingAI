...
import { OtifPlatformAgentService } from "../../services/otif-platform-agent.service";
import { SettingsService } from "../../services/settings.service";

@ExtensionConsoleController("settings", "OTIF Settings")
export class SettingsConsoleController extends BaseController {
    constructor(
        private readonly settingsService: SettingsService,
        private readonly ehcsPlatformAgentService: OtifPlatformAgentService,
    ) {
        super();
    }
