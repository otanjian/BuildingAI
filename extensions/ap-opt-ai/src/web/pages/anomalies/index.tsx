...
import { formatApOptDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="ap-opt-card">
                <table className="ap-opt-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatApOptDateTime(a.checkTime)}</td>
                                <td>{formatApOptDateTime(a.createTime)}</td>
                                <td>{formatApOptDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
