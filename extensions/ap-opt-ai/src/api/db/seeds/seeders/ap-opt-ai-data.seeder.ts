...
export class ApOptAiDataSeeder extends BaseSeeder {
    readonly name = "ApOptAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "AP-20260525-001",
                ruleId: "AP_001",
                description: "应付账款优化自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "AP-20260525-002",
                ruleId: "AP_008",
                description: "应付账款优化自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
