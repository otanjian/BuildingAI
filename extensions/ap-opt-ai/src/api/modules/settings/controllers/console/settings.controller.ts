...
import { ApOptPlatformAgentService } from "../../services/ap-opt-platform-agent.service";
import { SettingsService } from "../../services/settings.service";

@ExtensionConsoleController("settings", "APO Settings")
export class SettingsConsoleController extends BaseController {
    constructor(
        private readonly settingsService: SettingsService,
        private readonly ehcsPlatformAgentService: ApOptPlatformAgentService,
    ) {
        super();
    }
