...
import { formatHrComplianceDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="hr-compliance-card">
                <table className="hr-compliance-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatHrComplianceDateTime(a.checkTime)}</td>
                                <td>{formatHrComplianceDateTime(a.createTime)}</td>
                                <td>{formatHrComplianceDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
