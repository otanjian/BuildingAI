...
export class HrComplianceAiDataSeeder extends BaseSeeder {
    readonly name = "HrComplianceAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "HR-20260525-001",
                ruleId: "HR_001",
                description: "人力资源合规自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "HR-20260525-002",
                ruleId: "HR_008",
                description: "人力资源合规自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
