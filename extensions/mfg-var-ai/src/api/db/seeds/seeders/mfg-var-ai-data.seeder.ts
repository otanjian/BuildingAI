...
export class MfgVarAiDataSeeder extends BaseSeeder {
    readonly name = "MfgVarAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "MFG-20260525-001",
                ruleId: "MFG_001",
                description: "生产成本偏差自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "MFG-20260525-002",
                ruleId: "MFG_008",
                description: "生产成本偏差自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
