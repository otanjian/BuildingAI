...
import { formatMfgVarDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="mfg-var-card">
                <table className="mfg-var-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatMfgVarDateTime(a.checkTime)}</td>
                                <td>{formatMfgVarDateTime(a.createTime)}</td>
                                <td>{formatMfgVarDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
