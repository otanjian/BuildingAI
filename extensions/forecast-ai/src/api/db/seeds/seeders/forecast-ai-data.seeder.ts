...
export class ForecastAiDataSeeder extends BaseSeeder {
    readonly name = "ForecastAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "FCST-20260525-001",
                ruleId: "FCST_001",
                description: "销售预测校准自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "FCST-20260525-002",
                ruleId: "FCST_008",
                description: "销售预测校准自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
