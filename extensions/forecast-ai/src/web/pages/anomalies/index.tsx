...
import { formatForecastDateTime } from "../../lib/format-datetime";
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatForecastDateTime(a.checkTime)}</td>
                                <td>{formatForecastDateTime(a.createTime)}</td>
                                <td>{formatForecastDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
