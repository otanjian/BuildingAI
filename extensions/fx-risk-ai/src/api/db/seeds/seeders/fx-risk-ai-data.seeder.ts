...
export class FxRiskAiDataSeeder extends BaseSeeder {
    readonly name = "FxRiskAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "FX-20260525-001",
                ruleId: "FX_001",
                description: "外汇风险自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "FX-20260525-002",
                ruleId: "FX_008",
                description: "外汇风险自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
