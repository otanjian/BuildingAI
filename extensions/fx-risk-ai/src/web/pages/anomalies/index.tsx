...
import { formatFxRiskDateTime } from "../../lib/format-datetime";
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatFxRiskDateTime(a.checkTime)}</td>
                                <td>{formatFxRiskDateTime(a.createTime)}</td>
                                <td>{formatFxRiskDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
