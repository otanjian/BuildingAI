...
export function RcaModal({ anomaly, agentId, onClose }: Props) {
    ...
    return (
        <div className="fx-risk-modal-backdrop" onClick={onClose}>
            <div className="fx-risk-modal rca" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="fx-risk-chat-msgs" style={{ minHeight: 280, maxHeight: 400 }}>
                    ...
                    {(chat.status === "streaming" || chat.status === "submitted") && (
                        <div className="fx-risk-chat-msg ai">…</div>
                    )}
                </div>
                <div className="fx-risk-chat-inp">
                    ...
                    <button type="button" className="fx-risk-btn fx-risk-btn-outline" onClick={onClose}>
                        关闭
                    </button>
                </div>
            </div>
