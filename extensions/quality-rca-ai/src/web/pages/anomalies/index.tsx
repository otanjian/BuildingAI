...
import { formatQualityRcaDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="quality-rca-card">
                <table className="quality-rca-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatQualityRcaDateTime(a.checkTime)}</td>
                                <td>{formatQualityRcaDateTime(a.createTime)}</td>
                                <td>{formatQualityRcaDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
