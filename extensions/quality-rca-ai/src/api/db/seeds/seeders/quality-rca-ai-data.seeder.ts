...
export class QualityRcaAiDataSeeder extends BaseSeeder {
    readonly name = "QualityRcaAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "QA-20260525-001",
                ruleId: "QA_001",
                description: "质量异常追溯自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "QA-20260525-002",
                ruleId: "QA_008",
                description: "质量异常追溯自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
