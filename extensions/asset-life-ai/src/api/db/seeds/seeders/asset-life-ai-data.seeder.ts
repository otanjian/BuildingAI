...
export class AssetLifeAiDataSeeder extends BaseSeeder {
    readonly name = "AssetLifeAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "AST-20260525-001",
                ruleId: "AST_001",
                description: "固定资产全生命周期自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "AST-20260525-002",
                ruleId: "AST_008",
                description: "固定资产全生命周期自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
