...
import { formatAssetLifeDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="asset-life-card">
                <table className="asset-life-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatAssetLifeDateTime(a.checkTime)}</td>
                                <td>{formatAssetLifeDateTime(a.createTime)}</td>
                                <td>{formatAssetLifeDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
