...
import { ProcAuditPlatformAgentService } from "../../services/proc-audit-platform-agent.service";
import { SettingsService } from "../../services/settings.service";

@ExtensionConsoleController("settings", "PROC Settings")
export class SettingsConsoleController extends BaseController {
    constructor(
        private readonly settingsService: SettingsService,
        private readonly ehcsPlatformAgentService: ProcAuditPlatformAgentService,
    ) {
        super();
    }
