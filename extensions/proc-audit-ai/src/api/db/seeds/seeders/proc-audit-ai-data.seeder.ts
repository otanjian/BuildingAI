...
export class ProcAuditAiDataSeeder extends BaseSeeder {
    readonly name = "ProcAuditAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "PROC-20260525-001",
                ruleId: "PROC_001",
                description: "采购合规审查自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "PROC-20260525-002",
                ruleId: "PROC_008",
                description: "采购合规审查自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
