...
import { formatProcAuditDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="proc-audit-card">
                <table className="proc-audit-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatProcAuditDateTime(a.checkTime)}</td>
                                <td>{formatProcAuditDateTime(a.createTime)}</td>
                                <td>{formatProcAuditDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
