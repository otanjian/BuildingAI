...
export class BudgetControlAiDataSeeder extends BaseSeeder {
    readonly name = "BudgetControlAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "BDG-20260525-001",
                ruleId: "BDG_001",
                description: "预算执行监控自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "BDG-20260525-002",
                ruleId: "BDG_008",
                description: "预算执行监控自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
