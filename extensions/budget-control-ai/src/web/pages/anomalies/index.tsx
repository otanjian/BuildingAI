...
import { formatBudgetControlDateTime } from "../../lib/format-datetime";
    ...
    return (
        <>
            ...
            <div className="budget-control-card">
                <table className="budget-control-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatBudgetControlDateTime(a.checkTime)}</td>
                                <td>{formatBudgetControlDateTime(a.createTime)}</td>
                                <td>{formatBudgetControlDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
