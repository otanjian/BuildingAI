...
export class EnergyCarbonAiDataSeeder extends BaseSeeder {
    readonly name = "EnergyCarbonAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "ECO-20260525-001",
                ruleId: "ECO_001",
                description: "能源与碳排放自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "ECO-20260525-002",
                ruleId: "ECO_008",
                description: "能源与碳排放自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
