...
import { formatEnergyCarbonDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="energy-carbon-card">
                <table className="energy-carbon-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatEnergyCarbonDateTime(a.checkTime)}</td>
                                <td>{formatEnergyCarbonDateTime(a.createTime)}</td>
                                <td>{formatEnergyCarbonDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
