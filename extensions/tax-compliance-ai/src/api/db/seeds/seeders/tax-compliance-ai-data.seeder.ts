...
export class TaxComplianceAiDataSeeder extends BaseSeeder {
    readonly name = "TaxComplianceAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "TAX-20260525-001",
                ruleId: "TAX_001",
                description: "税务合规自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "TAX-20260525-002",
                ruleId: "TAX_008",
                description: "税务合规自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
