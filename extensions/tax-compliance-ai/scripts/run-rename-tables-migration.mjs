/**
 * Run TAX 0.1.3 table rename migration (tax-compliance-* prefix).
 *
 * Usage (from repo root, after `pnpm --filter tax-compliance-ai build:api`):
 *   node extensions/tax-compliance-ai/scripts/run-rename-tables-migration.mjs
 */
...
try {
    ...
    const tables = await dataSource.query(
        `SELECT table_name FROM information_schema.tables
         WHERE table_schema = 'tax_compliance_ai'
         ORDER BY table_name`,
    );
