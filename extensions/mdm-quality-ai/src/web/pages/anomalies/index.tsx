...
import { formatMdmQualityDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="mdm-quality-card">
                <table className="mdm-quality-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatMdmQualityDateTime(a.checkTime)}</td>
                                <td>{formatMdmQualityDateTime(a.createTime)}</td>
                                <td>{formatMdmQualityDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
