...
export class MdmQualityAiDataSeeder extends BaseSeeder {
    readonly name = "MdmQualityAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "MDM-20260525-001",
                ruleId: "MDM_001",
                description: "主数据质量自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "MDM-20260525-002",
                ruleId: "MDM_008",
                description: "主数据质量自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
