...
export class ChannelInvAiDataSeeder extends BaseSeeder {
    readonly name = "ChannelInvAiDataSeeder";
    ...
    async run(dataSource: DataSource): Promise<void> {
        ...
        await resultsRepo.save([
            resultsRepo.create({
                anomalyId: "CHI-20260525-001",
                ruleId: "CHI_001",
                description: "渠道库存协同自治示例异常：规则触发",
                riskLevel: "中",
            ...
            resultsRepo.create({
                anomalyId: "CHI-20260525-002",
                ruleId: "CHI_008",
                description: "渠道库存协同自治示例异常：低危可自动修复",
                riskLevel: "低",
                rootCause: "历史数据格式不一致",
