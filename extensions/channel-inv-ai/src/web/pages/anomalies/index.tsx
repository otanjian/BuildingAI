...
import { formatChannelInvDateTime } from "../../lib/format-datetime";
...
export default function AnomaliesPage() {
    ...
    return (
        <>
            ...
            <div className="channel-inv-card">
                <table className="channel-inv-table">
                    <thead>
                        <tr>
                            <th>异常ID</th>
                            <th>规则</th>
                    ...
                    <tbody>
                        {rows.map((a) => (
                            <tr key={a.anomalyId}>
                                ...
                                <td>{a.solution}</td>
                                <td>{a.status}</td>
                                <td>{formatChannelInvDateTime(a.checkTime)}</td>
                                <td>{formatChannelInvDateTime(a.createTime)}</td>
                                <td>{formatChannelInvDateTime(a.resolvedAt)}</td>
                                <td>
                                    <button
                                        type="button"
