...
- **AND** MUST NOT require waiting for BuildingAI persistence to finish before showing that progress
...
- **THEN** the system MUST show that conversation's BuildingAI-persisted messages as today
