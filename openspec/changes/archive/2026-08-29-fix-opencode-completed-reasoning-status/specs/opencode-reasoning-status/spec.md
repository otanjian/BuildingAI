...
The BuildingAI OpenCode embed MUST label a reasoning summary according to the lifecycle of its
assistant message.
...
### Requirement: The status change is isolated to the BuildingAI embed disclosure
