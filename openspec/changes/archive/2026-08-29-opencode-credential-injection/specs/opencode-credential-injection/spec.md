...
#### Scenario: Existing BuildingAI session

- **WHEN** an existing session already contains BuildingAI context created before this behavior was deployed
...
- **THEN** the assistant asks the user to update BuildingAI personal parameters rather than paste a password into chat
...
#### Scenario: BuildingAI bridge is unavailable
