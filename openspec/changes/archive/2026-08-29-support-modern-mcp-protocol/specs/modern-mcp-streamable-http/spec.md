...
Allow BuildingAI agents and administration tools to use modern MCP Streamable HTTP servers that place protocol metadata in each request envelope, while preserving existing legacy MCP integrations.
