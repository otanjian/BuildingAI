# bowi-mcp-sap-gateway Specification
...
- **WHEN** a logged-in Bowi AI user with an assigned SAP capability calls an approved tool
...
- **WHEN** OpenCode starts with Bowi AI-managed configuration
...
- **WHEN** a Bowi AI OpenCode session receives a Todo or SAP business request
