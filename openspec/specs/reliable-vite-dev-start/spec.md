# reliable-vite-dev-start Specification

## Purpose
Ensure the Bowi AI frontend development server starts against the current pnpm dependency graph and does not retain deleted virtual-store module paths after reinstall or upgrade operations.
## Requirements
