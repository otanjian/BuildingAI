# feishu-agent-channel Specification

## Purpose
Provide administrators with a secure, one-click way to connect a Feishu bot to a published standard
Bowi AI agent and operate that connection without maintaining a separate integration service.
## Requirements
...
Bowi AI agent access token, and whether the channel is enabled. The console SHALL never return
